...
export const FollowPointer = ({
    ...
    return (
        ...
        >
            ...
            >
                {title || (
                    <div className="absolute top-full left-full mt-1 ml-1 text-[10px] font-mono text-cyan-500 whitespace-nowrap bg-black/80 px-2 py-0.5 border border-cyan-500/30 rounded-sm">
                        TARGETING // ACTIVE
                    </div>
                )}
            </motion.div>
